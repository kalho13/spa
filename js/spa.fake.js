...
spa.fake = (function () {
  ...
  mockSio = (function(){
    ...
    emit_sio = function(msg_type, data){
      var person_map, i;
      //respond to 'addusers' event with 'userupdate'
      ...
      // Respond to 'updatechat' event with an 'updatechat' callback after a 2 second delay.  Echo back user info
      ...
      if(msg_type === 'updatechat'  && callback_map.updatechat){
        setTimeout(function(){
          ...
          callback_map.updatechat([{
            ...
            msg_text : 'Thanks for the note and all the hard work ' + user.name
          }])
      ...
      if(msg_type === 'updateavatar' && callback_map.listchange){
        console.log('msg_type === updateavatar');
        //simulate the receipt of a list change message
      ...
      setTimeout(function(){
        ...
        if(callback_map.updatechat){
          callback_map.updatechat([{
            ...
            dest_name : user.name,
            sender_id : 'id_04',
            msg_text : 'Hi There ' + user.name + ' Kal here.'
          }])
        }
        else { emit_mock_msg();}
      }, 8000);
  ...
  }());  //close the mockSio object closure
