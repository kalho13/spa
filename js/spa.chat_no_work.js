...
spa.chat = (function(){
	...
	/* do not understand the logic of function below */
	...
	var
	    ...
	    jqueryMap = { 
	    	...
	    	$box:$slider.find('.spa-chat-input input[type=text]')
	    };
...
*/
		...
		var 
		  ...
		  switch(position_type){
		  	...
		  	case 'closed':
		  		...
		  		toggle_text = '+';
		  		break;
		  	//bail for the unknow position_type
	...
	/* End public DOM methos /setSliderPosition/ */
	//---------------------- END DOM METHODS ---------------------
	//------------------- BEGIN EVENT HANDLERS -------------------

	//I do not see there the uriAnchor is being updated here?
